...
namespace UnityDialog
{
    ...
    public static class Dialog
    {
        ...
        /// OK string
        /// </summary>
        public static string OKString => ((DialogManagerScript.Instance == null) ? "OK" : ((DialogManagerScript.Instance.OKTranslation == null) ? "OK" : DialogManagerScript.Instance.OKTranslation.ToString()));

        /// <summary>
        /// Cancel string
        /// </summary>
        public static string CancelString => ((DialogManagerScript.Instance == null) ? "Cancel" : ((DialogManagerScript.Instance.CancelTranslation == null) ? "Cancel" : DialogManagerScript.Instance.CancelTranslation.ToString()));

        /// <summary>
        /// Yes string
        /// </summary>
        public static string YesString => ((DialogManagerScript.Instance == null) ? "Yes" : ((DialogManagerScript.Instance.YesTranslation == null) ? "Yes" : DialogManagerScript.Instance.YesTranslation.ToString()));

        /// <summary>
        /// No string
        /// </summary>
        public static string NoString => ((DialogManagerScript.Instance == null) ? "No" : ((DialogManagerScript.Instance.NoTranslation == null) ? "No" : DialogManagerScript.Instance.NoTranslation.ToString()));
